...
const startSound = new Audio('sound/start-game.mp3')
...
function stopAllSounds() {
    [startSound, fireSound, waterSound, forestSound].forEach(sound => {
        sound.pause();
        sound.currentTime = 0;
    });
}
...
function area2(itemsReceived) {
    document.getElementById("storyTxt").textContent = "You encounter a fierce dragon! Do you fight it or run away?";
    let c1 = document.getElementById("c1");
    let c2 = document.getElementById("c2");
    ...
    c1.addEventListener("click", function () {
        ...
        document.getElementById("yourActions").textContent = actions.join(", ");
        document.getElementById("storyTxt").textContent =
        "You decide to fight the dragon with your " + itemsReceived + ". After a tough battle, you emerge victorious! You continue your adventure with your new loot.";
        document.getElementById("inventory").textContent = inventory.join(", ");
    });
        c2.addEventListener("click", function () {
        actions.push("Nah, you're not scared of that guy. You fight him and win!");
        document.getElementById("yourActions").textContent = actions.join(", ");
        document.getElementById("storyTxt").textContent = "You fight the guy and win!";
    });
